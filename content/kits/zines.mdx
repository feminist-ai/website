...
<Card title="BubbleSort Zines" url="https://shop.bubblesort.io/collections/zines" image="/images/zines_bubblesort.jpg">Playful and cute zines by Amy Wibowo on a mission to empower women, girls and nonbinary folks in tech.</Card>
</Grid>
...
- **You don't need to illustrate from scratch.** There are many free resources for design assets you can use and combine. Instead of working with graphics, you can also focus on colors and fonts.
